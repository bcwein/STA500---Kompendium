...
\input{Kapittel/samandrag.tex}                      % Input fil for samandrag.
\end{abstract}
% =========== </Samandrag> ==========

% =========== <Hovudtekst> ===========
\tableofcontents
\input{Kapittel/sannsyn.tex}                        % Sannsynlegheitsfordelingar
\input{Kapittel/funksjoner.tex}                     % Funksjoner av stokastiske variablar
\input{Kapittel/ekstremverdistatistikk}             % Ekstremverdistatistikk
\input{Kapittel/estimering.tex}                     % Estimering
\input{Kapittel/modellar}                           % Statistiske modellar
\input{Kapittel/konsept}                            % Konsept
% =========== </Hovudtekst> ===========
